...
export default html`
	<svg width="24px" height="24px" viewBox="0 0 21 15" class="mdi">
		<defs>
			<linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="ES_svg__a_296">
				<stop stop-color="#FFF" offset="0%"></stop>
				<stop stop-color="#F0F0F0" offset="100%"></stop>
			</linearGradient>
			<linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="ES_svg__b_297">
				<stop stop-color="#DD172C" offset="0%"></stop>
				<stop stop-color="#C60B1F" offset="100%"></stop>
			</linearGradient>
			<linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="ES_svg__c_298">
				<stop stop-color="#FFD133" offset="0%"></stop>
				<stop stop-color="#FFC500" offset="100%"></stop>
			</linearGradient>
		</defs>
		<g fill="none" fill-rule="evenodd">
			<path fill="url(#ES_svg__a_296)" d="M0 0h21v15H0z"></path>
			<path fill="url(#ES_svg__b_297)" d="M0 0h21v4H0zm0 11h21v4H0z"></path>
			<path fill="url(#ES_svg__c_298)" d="M0 4h21v7H0z"></path>
			<path fill="#FFEDB1" d="M5.5 7h1v.5h-1z"></path>
			<path
